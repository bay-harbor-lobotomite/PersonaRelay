...
const ChatInput: React.FC<ChatInputProps> = ({ onSendMessage, isSending, isPersonaSelected }) => {
  ...
  return (
    ...
    style={{ backgroundColor: "var(--color-bg-secondary)", color: "var(--color-text-primary)" }}>
      ...
      <button type="submit" className="ml-4 p-3 text-white rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 disabled:opacity-50 interactive-grow" disabled={!input.trim() || isSending || !isPersonaSelected}
