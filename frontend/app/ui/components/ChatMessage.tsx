...
const ChatMessage = ({ message }: { message: Message }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`px-4 py-3 rounded-2xl max-w-[70%] sm:max-w-[60%] ${isUser ? 'bg-blue-500 text-white rounded-br-none' : 'bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-bl-none'}`}><p className="text-sm">{message.text}</p></div>
